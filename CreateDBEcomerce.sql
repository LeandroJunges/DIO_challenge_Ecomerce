...
-- Correção do auto incremente +1

ALTER TABLE products auto_increment =1;

-- Tabela de Pagamentos
CREATE TABLE payments(
    idPayment INT AUTO_INCREMENT = 1,
    idClient INT,
...
CREATE TABLE warehouses(
    idWarehouse INT AUTO_INCREMENT=1,
    idProduct INT,
    ZipCode CHAR(8) NOT NULL,
    Location VARCHAR(10),
...
CREATE TABLE suppliers(
    idSupplier INT AUTO_INCREMENT=1,
...
CREATE TABLE retailers(
    idRetailer INT AUTO_INCREMENT=1,
